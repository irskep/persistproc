...
from persistproc.core import LogManager
...
class TestLogManager:
    ...
    @patch("persistproc.core.threading.Thread")
    ...
    def test_log_stream_processing(self, temp_dir):
        ...
        with patch(
            "persistproc.utils.get_iso_timestamp",
            return_value="2023-01-01T12:00:00.000Z",
        ):
